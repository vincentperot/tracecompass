...
public interface ITmfTimeAligned {
     ...
     * all views. Implementations should handle cases were the requested offset
     * is greater than the width of the view. For example Integer.MAX_VALUE can
     * be requested in order to obtain the largest width possible.
     *
     * @param requestedOffset
     *            the requested time-axis offset
     * @return the available width. Can be Integer.MAX_VALUE.
     */
    int getAvailableWidth(int requestedOffset);

    /**
     * Perform the alignment by moving the time-axis to the specified offset and
     * the resizing it to the specified width.
     *
     * @param offset
     *            the time-axis offset
     * @param width
     *            the time-axis width
     */
