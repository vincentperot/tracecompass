...
public class ColorSetting {
     ...
     * @param tickColorRGB
     *            The color for the time graph ticks
     * @param filter
     *            The filter tree node, or null
     */
    public ColorSetting(@Nullable RGB foreground, @Nullable RGB background, @NonNull RGB tickColorRGB, @Nullable ITmfFilterTreeNode filter) {
