...
public class CallStackView extends TmfView {
    ...
    // a view
    private TmfVisibleRangeUpdatedSignal fSavedRangeSyncSignal;
    ...
    public void createPartControl(Composite parent) {
        ...
        fTimeGraphCombo.getTimeGraphViewer().addRangeListener(new ITimeGraphRangeListener() {
            ...
            public void timeRangeUpdated(TimeGraphRangeUpdateEvent event) {
                ...
                broadcast(new TmfVisibleRangeUpdatedSignal(CallStackView.this, range));
    ...
    /**
     * Handler for the visible range signal.
     *
     * @param signal
     *            The incoming signal
     * @since 1.0
     */
    @TmfSignalHandler
    public void visibleRangeUpdated(final TmfVisibleRangeUpdatedSignal signal) {

        if (isPinned()) {
            fSavedRangeSyncSignal =
                    new TmfVisibleRangeUpdatedSignal(signal.getSource(), new TmfTimeRange(signal.getCurrentRange().getStartTime(), signal.getCurrentRange().getEndTime()));
            ...
            public void propertyChange(PropertyChangeEvent event) {
                if (IAction.CHECKED.equals(event.getProperty()) && !isPinned()) {
                    if (fSavedRangeSyncSignal != null) {
                        visibleRangeUpdated(fSavedRangeSyncSignal);
