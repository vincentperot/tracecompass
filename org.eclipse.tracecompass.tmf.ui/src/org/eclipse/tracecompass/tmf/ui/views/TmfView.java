...
public abstract class TmfView extends ViewPart implements ITmfComponent {
    ...
    private PaintListener fPaintListener;
        ...
        if (this instanceof ITmfTimeAligned) {
            ...
            fPaintListener = new PaintListener() {
                ...
                public void paintControl(PaintEvent e) {
                    TIME_ALIGNMENT_SYNCHRONIZER.handleViewCreated(TmfView.this);
                    parent.removePaintListener(fPaintListener);
                    fPaintListener = null;
                }
            };
            parent.addPaintListener(fPaintListener);
                ...
                public void partClosed(IWorkbenchPart part) {
                    if (part == TmfView.this && fControlListener != null && !fParentComposite.isDisposed()) {
                        ...
                        if (fPaintListener != null) {
                            fParentComposite.removePaintListener(fPaintListener);
                            fPaintListener = null;
                        }
