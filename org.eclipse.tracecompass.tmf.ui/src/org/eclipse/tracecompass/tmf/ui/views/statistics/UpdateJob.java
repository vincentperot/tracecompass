...
public class UpdateJob extends Job {
     ...
     */
    public UpdateJob(String name, ITmfTrace trace, boolean isGlobal, TmfStatisticsModule statsMod, TmfStatisticsModel model) {
        super(name);
        fJobTrace = trace;
        fIsGlobal = isGlobal;
        fStatsMod = statsMod;
    ...
    private void updateStats(Map<String, Long> eventsPerType) {
         ...
         *
         * The base view shows the total count for the trace and for each even
         * types, organized in columns like this:
         *
        ...
        fModel.signalModelComplete(fIsGlobal);
    }
}
