...
public class Messages extends NLS {
    ...
    /** content */
    public static String RegionsOfInterestTable_content;
    /** duration */
    public static String RegionsOfInterestTable_duration;
    /** end time */
    public static String RegionsOfInterestTable_endTime;
    /** start time */
    public static String RegionsOfInterestTable_startTime;
    /** import */
