    ...
    public void createPartControl(Composite parent) {
        ...
        fTimeGraphWrapper.getTimeGraphViewer().addTimeListener(new ITimeGraphTimeListener() {
            ...
            public void timeSelected(TimeGraphTimeEvent event) {
                ...
                System.out.println(System.currentTimeMillis()+" "+Thread.currentThread().getName()+"::"+getClass().getSimpleName()+".timeSelected() calling broadcast("+new TmfSelectionRangeUpdatedSignal(AbstractTimeGraphView.this, startTime, endTime)+")");
