    ...
    public IStatus run(IProgressMonitor ipm) {
        ...
        fRequest = new TmfEventRequest(ITmfEvent.class, TmfTimeRange.ETERNITY,
            ...
            public void handleData(final ITmfEvent event) {
                ...
                fEventsTable.setFilterCheckCount(fEventsTable.getFilterCheckCount() + 1);
            }
        };
        ...
        synchronized (fEventsTable.fFilterSyncObj) {
            fEventsTable.fFilterThread = null;
            if (fEventsTable.fFilterThreadResume) {
                fEventsTable.fFilterThreadResume = false;
                fEventsTable.fFilterThread = new TmfFilterJob(fEventsTable, getFilter());
                fEventsTable.fFilterThread.schedule();
            }
        }
