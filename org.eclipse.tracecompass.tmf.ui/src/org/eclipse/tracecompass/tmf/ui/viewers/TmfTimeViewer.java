...
public abstract class TmfTimeViewer extends TmfViewer implements ITmfTimeProvider {
    ...
    /**
     * Signal handler for handling of the visible range signal.
     *
     * @param signal
     *            The {@link TmfVisibleRangeUpdatedSignal}
     * @since 1.0
     */
    @TmfSignalHandler
    public void visibleRangeUpdated(TmfVisibleRangeUpdatedSignal signal) {
