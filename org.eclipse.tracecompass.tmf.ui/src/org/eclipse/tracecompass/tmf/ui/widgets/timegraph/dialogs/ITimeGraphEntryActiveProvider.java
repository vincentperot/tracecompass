...
/**
 * Interface containing information for an additional view specific
 * is(In)Active-button to be used in TimeGraphFilterDialog.
 *
 * @since 1.0
 */
public interface ITimeGraphEntryActiveProvider {
     ...
     *            selecting/ticking
     * @return Returns true if this element is active and is to be selected.
     */
