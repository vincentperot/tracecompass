...
public class TmfTimeViewAlignmentSignal extends TmfSignal {
    ...
    private final boolean fIsSyncrhonous;
     ...
     *            is useful for signals that are getting sent not repetitively.
     ...
     */
    public TmfTimeViewAlignmentSignal(Object source, TmfTimeViewAlignmentInfo alignmentInfo, boolean syncrhonous) {
        super(source);
        fTimeViewAlignmentInfo = alignmentInfo;
        fIsSyncrhonous = syncrhonous;
    }
