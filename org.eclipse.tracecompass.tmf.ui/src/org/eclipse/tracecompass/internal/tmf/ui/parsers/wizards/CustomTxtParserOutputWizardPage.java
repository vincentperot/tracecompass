...
public class CustomTxtParserOutputWizardPage extends WizardPage {
    ...
    public void createControl(final Composite parent) {
        ...
        previewTable = new TmfEventsTable(tableContainer, 0, CustomEventCriteria.generateCriteria(new CustomTxtTraceDefinition()));
    ...
    private void updatePreviewTable() {
        ...
        try {
            ...
            previewTable.dispose();
            previewTable = new TmfEventsTable(tableContainer, CACHE_SIZE, CustomEventCriteria.generateCriteria(definition));
            previewTable.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
