...
public class Messages extends NLS {
    ...
    public static String CopyToClipboardJob_Name;
    public static String CopyToClipboardJob_OutOfMemoryErrorTitle;
    public static String CopyToClipboardJob_OutOfMemoryErrorMessage;
