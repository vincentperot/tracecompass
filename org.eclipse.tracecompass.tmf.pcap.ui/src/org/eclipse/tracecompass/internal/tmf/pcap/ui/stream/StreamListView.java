...
public class StreamListView extends TmfView {
    ...
    private static final String TRACE_TYPE_ID = "org.eclipse.linuxtools.tmf.pcap.core.pcaptrace"; //$NON-NLS-1$
            ...
            if (protocol.supportsStream()) {
                ...
                menuItem.addListener(SWT.Selection, new Listener() {
                    ...
                    private @Nullable ITmfFilterTreeNode generateFilter() {
                        ...
                        endpointAAndA.setEventAspect(new PcapSourceAspect());
                        endpointAAndA.setTraceTypeId(TRACE_TYPE_ID);
                        endpointAAndA.setValue(stream.getFirstEndpoint());
                        TmfFilterContainsNode endpointBAndA = new TmfFilterContainsNode(andA);
                        endpointBAndA.setEventAspect(new PcapDestinationAspect());
                        endpointBAndA.setTraceTypeId(TRACE_TYPE_ID);
                        endpointBAndA.setValue(stream.getSecondEndpoint());
                        TmfFilterContainsNode endpointAAndB = new TmfFilterContainsNode(andB);
                        endpointAAndB.setEventAspect(new PcapSourceAspect());
                        endpointAAndB.setTraceTypeId(TRACE_TYPE_ID);
                        endpointAAndB.setValue(stream.getSecondEndpoint());
                        TmfFilterContainsNode endpointBAndB = new TmfFilterContainsNode(andB);
                        endpointBAndB.setEventAspect(new PcapDestinationAspect());
                        endpointBAndB.setTraceTypeId(TRACE_TYPE_ID);
