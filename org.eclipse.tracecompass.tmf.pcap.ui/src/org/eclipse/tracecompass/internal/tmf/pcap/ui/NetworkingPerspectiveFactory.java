...
public class NetworkingPerspectiveFactory implements IPerspectiveFactory {
    ...
    // Views
    private static final String PROJECT_VIEW_ID = checkForNull(IPageLayout.ID_PROJECT_EXPLORER);
    private static final String PROPERTIES_VIEW_ID = checkForNull(IPageLayout.ID_PROP_SHEET);
    private static final String BOOKMARKS_VIEW_ID = checkForNull(IPageLayout.ID_BOOKMARKS);
