...
public class LTTngControlServiceTest {
    ...
    public void testVersion() {
        try {
            ...
            ILttngControlService service = LTTngControlServiceFactory.INSTANCE.getLttngControlService(fShell);
    ...
    public void testUnsupportedVersion() {
        try {
            ...
            LTTngControlServiceFactory.INSTANCE.getLttngControlService(fShell);
