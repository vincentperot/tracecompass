...
public class SequenceDeclaration2Test {
    ...
    public void hashcodeTest() {
        ...
        SequenceDeclaration b = new SequenceDeclaration(FIELD_NAME, IntegerDeclaration.INT_32B_DECL);
        SequenceDeclaration c = new SequenceDeclaration("Hi", new StringDeclaration());
        SequenceDeclaration d = new SequenceDeclaration(FIELD_NAME, new StringDeclaration());
        ...
        assertNotEquals(c.hashCode(), fixture.hashCode());
        assertEquals(d.hashCode(), fixture.hashCode());
