...
public class ArrayDefinitionTest {
    ...
    private ArrayDefinition createLongArray() {
        ...
        List<IDefinition> defs = createIntDefs(10, 32);
    ...
    private ArrayDefinition createCharArray() {
        ...
        List<IDefinition> defs = createIntDefs(4, 8);
        ArrayDefinition temp = setUpDeclaration(decl, defs);
        return temp;
    }
    ...
    @NonNull
    private static List<IDefinition> createIntDefs(int size, int bits) {
        List<IDefinition> defs = new ArrayList<>(size);
    ...
    @NonNull
    private static List<IDefinition> createDefs() {
        int size = 4;
        List<IDefinition> defs = new ArrayList<>();
        for (int i = 0; i < size; i++) {
            String content = "test" + i;
    ...
    public void testArrayDefinition_baseDeclaration() {
        ...
        ArrayDefinition result = new ArrayDefinition(declaration, this.trace, fieldName, Arrays.asList(new IDefinition[0]));
    ...
    public void testArrayDefinition_newDeclaration() {
        ...
        String fieldName = "";
        @SuppressWarnings("null")
        ArrayDefinition result = new ArrayDefinition(declaration, definitionScope, fieldName, Arrays.asList(new IDefinition[0]));
        assertNotNull(result);
    }
    ...
    public void testGetDeclaration() {
        ICompoundDeclaration result = (ICompoundDeclaration) charArrayFixture.getDeclaration();
