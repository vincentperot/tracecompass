...
public class EventHeaderDeclarationTest {
    ...
    public void init() {
        ...
        // bad - int 5 alignment
        base = new StructDeclaration(8);
        enumDec = new EnumDeclaration(IntegerDeclaration.UINT_5B_DECL);
        enumDec.add(0, 30, "compact");
        base.addField("id", enumDec);
        variantV = new VariantDeclaration();
        compact = new StructDeclaration(1);
    ...
    public void validateCompact() {
        assertEquals(true, new EventHeaderCompactDeclaration(ByteOrder.BIG_ENDIAN).isCompactEventHeader(declarations.get(VALID_COMPACT)));
    }
    ...
    public void validateCompactFail() {
        for (int i = 0; i < declarations.size(); i++) {
            ...
            assertEquals(false, new EventHeaderCompactDeclaration(ByteOrder.BIG_ENDIAN).isCompactEventHeader(declarations.get(i)));
        }
    }
    ...
    public void validateLarge() {
        assertEquals(true, new EventHeaderLargeDeclaration(ByteOrder.BIG_ENDIAN).isLargeEventHeader(declarations.get(VALID_LARGE)));
    }
    ...
    public void validateLargeFail() {
        for (int i = 0; i < declarations.size(); i++) {
            ...
            assertEquals(false, new EventHeaderLargeDeclaration(ByteOrder.BIG_ENDIAN).isLargeEventHeader(declarations.get(i)));
        }
    }
