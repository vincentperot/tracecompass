...
public class IntegerDeclarationTest {
    ...
    public void hashcodeTest() {
        IntegerDeclaration createDeclaration = IntegerDeclaration.createDeclaration(8, false, 10, ByteOrder.BIG_ENDIAN, Encoding.NONE, "", 8);
        ...
        assertEquals(234767053, createDeclaration.hashCode());
        assertEquals(b.hashCode(), createDeclaration.hashCode());
        assertNotEquals(a.hashCode(), createDeclaration.hashCode());
    }
