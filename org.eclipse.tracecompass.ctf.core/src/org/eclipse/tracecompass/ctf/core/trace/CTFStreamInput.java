...
public class CTFStreamInput implements IDefinitionScope {
    ...
    private ICTFPacketInformation createPacketIndexEntry(long dataOffsetbits)
            throws CTFException {
    ...
    private ICTFPacketInformation parsePacketContext(long dataOffsetBits, long fileSizeBytes,
            BitBuffer bitBuffer) throws CTFException {
