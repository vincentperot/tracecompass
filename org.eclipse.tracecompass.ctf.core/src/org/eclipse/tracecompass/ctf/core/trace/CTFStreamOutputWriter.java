...
public class CTFStreamOutputWriter {
    ...
    // Attributes
    // ------------------------------------------------------------------------
    @Nullable private CTFStreamInput fStreamInput;
    @NonNull private CTFStreamPacketOutputWriter fStreamPacketOutputWriter;
    @NonNull private File fOutFile;
    ...
    /**
     * Get the stream input file to copy from.
     *
     * @return stream input file
     */
    public @Nullable File getInFile() {
        CTFStreamInput streamInput = fStreamInput;
        if (streamInput == null) {
            return null;
        }
        return streamInput.getFile();
    }
