...
public class CTFStreamOutputWriter {
    ...
    @Nullable final private CTFStreamInput fStreamInput;
    @NonNull final private CTFStreamPacketOutputWriter fStreamPacketOutputWriter;
    @NonNull final private File fOutFile;
