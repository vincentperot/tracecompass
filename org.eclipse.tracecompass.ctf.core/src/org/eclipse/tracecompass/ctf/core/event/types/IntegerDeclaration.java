...
public class IntegerDeclaration extends Declaration implements ISimpleDatatypeDeclaration {
    ...
    private IntegerDeclaration(int len, boolean signed, int base,
        ...
        fByteOrder = (byteOrder == null ? checkForNull(ByteOrder.nativeOrder()) : byteOrder);
    ...
    public BigInteger getMaxValue() {
         ...
         * << N) - 1.
         */
        return checkForNull(BigInteger.ONE.shiftLeft(significantBits).subtract(BigInteger.ONE));
    }
    ...
    public BigInteger getMinValue() {
        if (!fSigned) {
            return checkForNull(BigInteger.ZERO);
        }
         ...
         * (1 << N).
         */
        return checkForNull(BigInteger.ONE.shiftLeft(significantBits).negate());
    }
