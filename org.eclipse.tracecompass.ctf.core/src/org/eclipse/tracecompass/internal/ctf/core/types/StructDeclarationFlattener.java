...
import org.eclipse.tracecompass.ctf.core.types.ISimpleDatatypeDeclaration;
...
public final class StructDeclarationFlattener {
     ...
     */
    private static boolean canBeFlattened(@NonNull ICompositeDeclaration sd) {
    ...
    private static boolean isFixedSize(IDeclaration dec) {
        ...
        if (dec instanceof StructDeclaration) {
            ICompositeDeclaration sDec = ((ICompositeDeclaration) dec);
