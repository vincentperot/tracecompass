...
public class StreamInputPacketIndexEntry implements Comparable<StreamInputPacketIndexEntry> {
    ...
    /**
     * Stream input packet entry constructor for networked streams
     *
     * @param dataIn
    ...
    public StreamInputPacketIndexEntry(DataInputStream dataIn) throws IOException {
        ...
        fTarget = Long.toString(fTargetID);
        fAttributes = Collections.emptyMap();
    }

    /**
     * Streamed stream input packet index entry ctor with target
     *
     * @param dataIn
     *            the datastream
     * @param target
     ...
     *
     * @param dataOffsetBits
     *            offset in the file for the start of data >>>>>>> 8eb3074...
    ...
    /**
     * <<<<<<< HEAD Add an attribute to this index entry
     *
     * @param field
    ...
    /**
     * ======= >>>>>>> 8eb3074... ctf: make StreamInputPacketReader immutable
