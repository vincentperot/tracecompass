...
public final class CTFStreamInputPacketReader implements IPacketReader {
    ...
    public final IEventDefinition readNextEvent() throws CTFException {
        ...
        IEventDefinition eventDef = eventDeclaration.createDefinition(fStreamInputReader.getStreamEventContextDecl(), fStreamInputReader.getPacketReader().getStreamPacketContextDefinition(fBitBuffer), fBitBuffer, timestamp);
