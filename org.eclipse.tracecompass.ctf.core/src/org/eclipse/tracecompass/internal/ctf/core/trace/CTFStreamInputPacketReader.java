...
public class CTFStreamInputPacketReader implements IDefinitionScope, AutoCloseable {
    ...
    private final ICompositeDeclaration fStreamEventContextDecl;
     ...
     */
    public ICompositeDefinition getEventContextDefinition(@NonNull BitBuffer input) throws CTFReaderException {
     ...
     *             out of bounds exception or such
     */
    public ICompositeDefinition getStreamPacketContextDefinition(@NonNull BitBuffer input) throws CTFReaderException {
     ...
     *             out of bounds exception or such
     */
    public ICompositeDefinition getTracePacketHeaderDefinition(@NonNull BitBuffer input) throws CTFReaderException {
        ...
        if (fStreamEventHeaderDecl != null) {
            if (fStreamEventHeaderDecl instanceof IEventHeaderDeclaration) {
                ...
                if (variantDef instanceof VariantDefinition) {
                    ...
                    StructDefinition variantCurrentField = (StructDefinition) ((IVariantDefinition) variantDef).getCurrentField();
