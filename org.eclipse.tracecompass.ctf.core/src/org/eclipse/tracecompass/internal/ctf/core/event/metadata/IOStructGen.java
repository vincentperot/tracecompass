...
public class IOStructGen {
    ...
    private void parseRoot(CommonTree root) throws ParseException {
        ...
        parseEvents(hasStreams, events);
        popScope();
        fHasBeenParsed = true;
    }

    private void parseEvents(boolean hasStreams, List<CommonTree> events) throws ParseException {
    ...
    private void parseIncompleteRoot(CommonTree root) throws ParseException {
        ...
        parseEvents(Iterables.isEmpty(fTrace.getStreams()), events);
        popScope();
    }
