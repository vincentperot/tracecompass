...
public class EventHeaderCompactDeclaration extends Declaration implements IEventHeaderDeclaration {
    ...
    public static final EventHeaderCompactDeclaration EVENT_HEADER_BIG_ENDIAN = new EventHeaderCompactDeclaration(ByteOrder.BIG_ENDIAN);

    /**
     * Little-Endian Large Event Header
     */
    @SuppressWarnings("null")
    public static final EventHeaderCompactDeclaration EVENT_HEADER_LITTLE_ENDIAN = new EventHeaderCompactDeclaration(ByteOrder.LITTLE_ENDIAN);
