...
import org.eclipse.tracecompass.ctf.core.types.IVariantDeclaration;
 ...
 * @author Simon Marchi
 */
public class VariantDeclaration extends Declaration implements IVariantDeclaration{
    ...
    public VariantDefinition createDefinition(IDefinitionScope definitionScope,
        ...
        IDefinition fieldValue = fDeclarationToPopulate.createDefinition(definitionScope, fieldName, input);
