...
public abstract class ScopedDefinition extends Definition implements IDefinitionScope {
     ...
     */
    public @Nullable ICompoundDefinition lookupArrayDefinition(String name) {
        IDefinition def = lookupDefinition(name);
        return (ICompoundDefinition) ((def instanceof AbstractArrayDefinition) ? def : null);
    }
     ...
     */
    @Nullable
    public IIntersectsDefinition lookupVariant(String name) {
        IDefinition def = lookupDefinition(name);
        return (IIntersectsDefinition) ((def instanceof VariantDefinition) ? def : null);
    }
}