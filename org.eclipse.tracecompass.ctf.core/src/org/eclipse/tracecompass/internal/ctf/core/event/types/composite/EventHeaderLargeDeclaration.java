...
public class EventHeaderLargeDeclaration extends Declaration implements IEventHeaderDeclaration {
    ...
    private void populateReferences() {
        ...
        EnumDeclaration id = new EnumDeclaration(IntegerDeclaration.createDeclaration(16, false, 10, fByteOrder, Encoding.NONE, "", 1)); //$NON-NLS-1$
        ...
        extended.addField("timestamp", IntegerDeclaration.createDeclaration(64, false, 10, fByteOrder, Encoding.NONE, "", 8)); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        ref = new StructDeclaration(ALIGN);
        id = new EnumDeclaration(IntegerDeclaration.createDeclaration(16, false, 10, fByteOrder, Encoding.NONE, "", 8)); //$NON-NLS-1$
        id.add(0, 65534, "compact"); //$NON-NLS-1$
        id.add(65535, 65535, "extended"); //$NON-NLS-1$
        ref.addField("id", id); //$NON-NLS-1$
        ...
        compact.addField("timestamp", IntegerDeclaration.createDeclaration(32, false, 10, fByteOrder, Encoding.NONE, "", 8)); //$NON-NLS-1$ //$NON-NLS-2$
        extended = new StructDeclaration(1);
        extended.addField("id", IntegerDeclaration.createDeclaration(32, false, 10, fByteOrder, Encoding.NONE, "", 8)); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        fReferenceStructs.add(ref);
        ref = new StructDeclaration(ALIGN);
        id = new EnumDeclaration(IntegerDeclaration.createDeclaration(16, false, 10, fByteOrder, Encoding.NONE, "", 16)); //$NON-NLS-1$
        id.add(0, 65534, "compact"); //$NON-NLS-1$
        id.add(65535, 65535, "extended"); //$NON-NLS-1$
        ref.addField("id", id); //$NON-NLS-1$
        v = new VariantDeclaration();
    ...
    public boolean isBinaryEquivalent(@Nullable IDeclaration other) {
        return fReferenceStructs.get(0).isBinaryEquivalent(other);
    }
