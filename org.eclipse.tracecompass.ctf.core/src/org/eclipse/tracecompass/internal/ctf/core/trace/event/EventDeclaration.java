...
package org.eclipse.tracecompass.internal.ctf.core.trace.event;
...
public class EventDeclaration implements IEventDeclaration {
    ...
    public EventDefinition createDefinition(CTFStreamInputReader streamInputReader, @NonNull BitBuffer input, long timestamp) throws CTFReaderException {
        ICompositeDeclaration streamEventContextDecl = streamInputReader.getStreamEventContextDecl();
        StructDefinition streamEventContext = (StructDefinition) (streamEventContextDecl != null ? streamEventContextDecl.createDefinition(fStream.getTrace(), LexicalScope.STREAM_EVENT_CONTEXT, input) : null);
        StructDefinition packetContext = streamInputReader.getPacketReader().getCurrentPacketEventHeader();
        StructDefinition eventContext = (StructDefinition) (fContext != null ? fContext.createDefinition(fStream.getTrace(), LexicalScope.CONTEXT, input) : null);
        StructDefinition eventPayload = (StructDefinition) (fFields != null ? fFields.createDefinition(fStream.getTrace(), LexicalScope.FIELDS, input) : null);
