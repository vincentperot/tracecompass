...
public final class ArrayDeclaration extends CompoundDeclaration {
    ...
    public AbstractArrayDefinition createDefinition(@Nullable IDefinitionScope definitionScope,
        ...
        @NonNull List<IDefinition> definitions = read(input, definitionScope, fieldName);
    ...
    private @NonNull List<IDefinition> read(@NonNull BitBuffer input, @Nullable IDefinitionScope definitionScope, String fieldName) throws CTFReaderException {
        Builder<IDefinition> definitions = new ImmutableList.Builder<>();
        ...
        @NonNull
        ImmutableList<IDefinition> ret = definitions.build();
        return ret;
    }
