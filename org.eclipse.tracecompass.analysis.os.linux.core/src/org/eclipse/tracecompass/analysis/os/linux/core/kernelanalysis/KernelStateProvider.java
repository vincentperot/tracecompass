 ...
 *
 */
public class KernelStateProvider extends AbstractTmfStateProvider implements IKernelStateProvider {
    ...
    protected void eventHandle(@Nullable ITmfEvent event) {
        ...
        try {
            ...
            case STATEDUMP_PROCESS_STATE_INDEX:
                handleLttngStatedumpProcessState(event, ts, ss);
                break;
    ...
    @Override
    // ------------------------------------------------------------------------
    // IKernelStateProvider
    // ------------------------------------------------------------------------
    public void handleSyscallExit(final ITmfStateSystemBuilder ss, final long ts, final int currentCPUNode, final int currentThreadNode) throws AttributeNotFoundException {
        int quark;
    ...
    @Override
    public void handleSyscallEntry(final ITmfStateSystemBuilder ss, final long ts, final String eventName, final int currentCPUNode, final int currentThreadNode) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
    ...
    @Override
    public void handleSchedWakeup(final ITmfStateSystemBuilder ss, final long ts, ITmfEvent event) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
        {
    ...
    private static void handleLttngStatedumpProcessState(ITmfEvent event, final long ts, final ITmfStateSystemBuilder ss) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
        /* LTTng-specific */
        {
    ...
    @Override
    public void handleSchedProcessFree(final ITmfStateSystemBuilder ss, final long ts, ITmfEvent event) throws AttributeNotFoundException {
        int quark;
        {
    ...
    @Override
    public void handleSchedProcessFork(final ITmfStateSystemBuilder ss, final long ts, ITmfEvent event) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
        {
            ITmfEventField content = event.getContent();
    ...
    @Override
    public void handleSchedSwitch(final ITmfStateSystemBuilder ss, final long ts, ITmfEvent event, final int currentCPUNode) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
        {
            ITmfEventField content = event.getContent();
    ...
    @Override
    public void handleSoftIrqRaise(final ITmfStateSystemBuilder ss, final long ts, ITmfEvent event) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
        /* Fields: int32 vec */
        {
    ...
    @Override
    public void handleSoftIrqExit(final ITmfStateSystemBuilder ss, final long ts, ITmfEvent event, final int currentCPUNode, final int currentThreadNode) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
        {
            Integer softIrqId = ((Long) event.getContent().getField(fLayout.fieldVec()).getValue()).intValue();
    ...
    @Override
    public void handleSoftIrqHandlerEntry(final ITmfStateSystemBuilder ss, final long ts, ITmfEvent event, Integer cpu, final int currentCPUNode, final int currentThreadNode) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
        {
            Integer softIrqId = ((Long) event.getContent().getField(fLayout.fieldVec()).getValue()).intValue();
    ...
    @Override
    public void handleIrqHandlerExit(final ITmfStateSystemBuilder ss, final long ts, ITmfEvent event, final int currentCPUNode, final int currentThreadNode) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
        {
    ...
    @Override
    public void handleIrqHandlerEntry(final ITmfStateSystemBuilder ss, final long ts, ITmfEvent event, Integer cpu, final int currentCPUNode, final int currentThreadNode) throws AttributeNotFoundException {
        int quark;
        ITmfStateValue value;
        {
            Integer irqId = ((Long) event.getContent().getField(fLayout.fieldIrq()).getValue()).intValue();
