    ...
    protected void eventHandle(@Nullable ITmfEvent event) {
        ...
        try {
            ...
            case SCHED_SWITCH_INDEX:
            {
                ...
                Integer nextPrio = ((Integer) content.getField("next_prio").getValue()).intValue(); //$NON-NLS-1$
            ...
            case SCHED_PI_SETPRIO_INDEX:
            {
                ...
                Integer prio = ((Integer) content.getField("newprio").getValue()).intValue(); //$NON-NLS-1$
            ...
            case SCHED_WAKEUP_INDEX:
            {
                ...
                final int prio = ((Integer) event.getContent().getField("prio").getValue()).intValue(); //$NON-NLS-1$
