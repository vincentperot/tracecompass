...
public class KernelStateProvider extends AbstractTmfStateProvider
    ...
    protected void eventHandle(@Nullable ITmfEvent event) {
        ...
        /* TODO Move all this to the concept concept */
    ...
    public void visit(ISchedSwitchConcept concept, ITmfEvent event) {
        ...
        try {
            ...
            Integer prevTid = concept.getPrevTid(event);
            Long prevState = concept.getPrevState(event);
            String nextProcessName = concept.getNextProcName(event);
            Integer nextTid = concept.getNextTid(event);
    ...
    public void visit(ISchedWakeupConcept concept, ITmfEvent event) {
        ...
        try {
            ...
            final Integer tid = concept.getPrevTid(event);
