    ...
    protected void eventHandle(@Nullable ITmfEvent event) {
        ...
        try {
            ...
            case SCHED_SWITCH_INDEX:
            {
                ...
                Long nextPrio = ((Long) content.getField("next_prio").getValue()).longValue(); //$NON-NLS-1$
                ...
                value = TmfStateValue.newValueLong(nextPrio);
                ss.modifyAttribute(ts, value, quark);
            ...
            case SCHED_PI_SETPRIO_INDEX:
            {
                ...
                Long prio = ((Long) content.getField("newprio").getValue()).longValue(); //$NON-NLS-1$
                ...
                value = TmfStateValue.newValueLong(prio);
                ss.modifyAttribute(ts, value, quark);
            }
                break;
            ...
            case SCHED_WAKEUP_INDEX:
            {
                ...
                final long prio = ((Long) event.getContent().getField("prio").getValue()).longValue(); //$NON-NLS-1$
