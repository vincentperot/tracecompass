...
public class KernelIrqHandler extends AbstractKernelEventHandlerWithCpuAndThread {

    public KernelIrqHandler(IKernelAnalysisEventLayout layout) {
        super(layout);
    }
     ...
     * of an interruption.
     */
    protected static void cpuExitInterrupt(ITmfStateSystemBuilder ssb, long ts,
