...
public class HistogramDataModelTest {
    ...
    private static final HistogramBucket _97 = new HistogramBucket(new int[] { 97 });
    ...
    public void testScaleTo_1() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _1, _1, _1, _1, _1, _1, _1, _1, _1, _0 };
    ...
    public void testScaleTo_4() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _4, _4, _4, _4, _4, _4, _4, _4, _2, _0 };
    ...
    public void testScaleTo_6() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _24, _20, _20, _20, _20, _20, _20, _20, _20, _17 };
    ...
    public void testScaleTo_7() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _104, _97 };
    ...
    public void testScaleToReverse_1() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _21, _20, _20, _20, _20, _20, _20, _20, _20, _20 };
        ...
        assertEquals(21, result.fMaxValue);
        assertEquals((double) maxHeight / 21, result.fScalingFactor, DELTA);
        assertEquals(maxHeight, result.fHeight);
        assertEquals(width, result.fWidth);
        assertEquals(barWidth, result.fBarWidth);
    ...
    public void testLostEventsScaleTo_0() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _4, _4, _4, _4, _4, _4, _4, _4, _2, _0 };
        final int[] expectedLostEventsResult = new int[] { 0, 2, 2, 0, 0, 3, 3, 3, 0, 0 };
    ...
    public void testLostEventsScaleTo_1() {
        ...
        final int nbLostEvents_1 = 9;
        final int nbCombinedEvents = nbEvents + 2;
        final int[] expectedLostEventsResult = new int[] { 0, 2, 5, 3, 3, 3, 0, 0, 0, 0 };
    ...
    public void testLostEventsScaleTo_2() {
        ...
        final int[] expectedLostEventsResult = new int[] { 0, 0, 3, 3, 3, 6, 5, 3, 2, 0 };
    ...
    public void testLostEventsScaleTo_3() {
        ...
        final int[] expectedLostEventsResult = new int[] { 0, 0, 5, 5, 5, 5, 5, 3, 0, 0 };
    ...
    public void testLostEventsScaleTo_4() {
        ...
        final int nbLostEvents_1 = 9;
        final int nbCombinedEvents = nbEvents + 2;
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _3, _4, _4, _4, _4, _4, _4, _4, _3, _0 };
        final int[] expectedLostEventsResult = new int[] { 4, 2, 0, 3, 3, 3, 3, 0, 0, 0 };
