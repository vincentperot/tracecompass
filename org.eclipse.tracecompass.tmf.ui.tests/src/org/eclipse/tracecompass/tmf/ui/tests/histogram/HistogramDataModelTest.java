...
public class HistogramDataModelTest {
    ...
    private static final HistogramBucket _6 = new HistogramBucket(new int[] { 6 });
    private static final HistogramBucket _7 = new HistogramBucket(new int[] { 7 });
    private static final HistogramBucket _8 = new HistogramBucket(new int[] { 8 });
    ...
    private static final HistogramBucket _22 = new HistogramBucket(new int[] { 22 });
    ...
    private static final HistogramBucket _104 = new HistogramBucket(new int[] { 104 });
    ...
    public void testScaleTo_2() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _1, _1, _1, _1, _1, _1, _2, _2, _2, _2 };
    ...
    public void testScaleTo_3() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _2, _2, _2, _2, _2, _2, _4, _4, _4, _4 };
    ...
    public void testScaleTo_4() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _4, _4, _8, _4, _4, _4, _4, _4, _4, _6 };
    ...
    public void testScaleTo_5() {
        ...
        final int nbEvents = 2 * nbBuckets;
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _20, _20, _20, _20, _20, _20, _22, _22, _22, _22 };
    ...
    public void testScaleTo_6() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _24, _24, _24, _24, _24, _24, _24, _24, _24, _21 };
    ...
    public void testScaleTo_7() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _104, _101 };
    ...
    public void testScaleToReverse_1() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _21, _24, _24, _24, _24, _24, _24, _24, _24, _24 };
    ...
    public void testLostEventsScaleTo_0() {
        ...
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _4, _4, _8, _4, _4, _4, _4, _4, _4, _6 };
        final int[] expectedLostEventsResult = new int[] { 0, 2, 4, 2, 0, 3, 3, 3, 3, 3 };
        ...
        assertEquals(12, result.fMaxCombinedValue);
    }
    ...
    public void testLostEventsScaleTo_1() {
        ...
        final int nbLostEvents_1 = 9;
        final int nbCombinedEvents = nbEvents + 2;
        final int[] expectedLostEventsResult = new int[] { 0, 2, 7, 5, 3, 3, 3, 0, 0, 0 };
        ...
        testModelConsistency(model, nbBuckets, nbCombinedEvents, 4, 0, 0, nbEvents - 1, 4 * nbBuckets);
        assertEquals(15, result.fMaxCombinedValue);
    }
    ...
    public void testLostEventsScaleTo_2() {
        ...
        final int[] expectedLostEventsResult = new int[] { 0, 0, 3, 3, 3, 6, 6, 5, 3, 5 };
        ...
        testModelConsistency(model, nbBuckets, nbCombinedEvents, 4, 0, 0, nbEvents - 1, 4 * nbBuckets);
        assertEquals(11, result.fMaxCombinedValue);
    }
    ...
    public void testLostEventsScaleTo_3() {
        ...
        final int[] expectedLostEventsResult = new int[] { 0, 0, 5, 5, 5, 5, 5, 5, 3, 3 };
        ...
        testModelConsistency(model, nbBuckets, nbCombinedEvents, 4, 0, 0, nbEvents - 1, 4 * nbBuckets);
        assertEquals(13, result.fMaxCombinedValue);
    }
    ...
    public void testLostEventsScaleTo_4() {
        ...
        final int nbLostEvents_1 = 9;
        final int nbCombinedEvents = nbEvents + 2;
        final HistogramBucket[] expectedResult = new HistogramBucket[] { _3, _4, _8, _4, _4, _4, _4, _4, _4, _7 };
        final int[] expectedLostEventsResult = new int[] { 4, 2, 2, 0, 3, 3, 3, 3, 0, 0 };
