...
public class VirtualMachinePresentationProvider extends TimeGraphPresentationProvider {
    ...
    private enum State {
        ...
        THREAD_UNKNOWN(new RGB(200, 200, 200)),
    ...
    public Map<String, String> getEventHoverToolTipInfo(@Nullable ITimeEvent event, long hoverTime) {
         ...
         *
         * Hint by Patrick: FYI it will be the event previous to the first event
         * that starts after the hover time in the event list, as long as that
         * previous event does not end before the hover time.
         */
