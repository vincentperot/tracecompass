        ...
        try {
            ...
            while (!complete && currentEnd < end) {
                ...
                for (int quark : tidQuarks) {
                    ...
                    fMemoryQuarks.put(quark, ss.getQuarkRelative(quark, UstStrings.UST_MEMORY_MEMORY_ATTRIBUTE));
                    int procNameQuark = ss.getQuarkRelative(quark, UstStrings.UST_MEMORY_PROCNAME_ATTRIBUTE);
                    try {
