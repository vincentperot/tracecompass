...
public class ColorsViewTest {
    ...
    public void testYellow() {
        ...
        SWTBotUtils.waitForJobs(); // should fix race condition of loading the
                                   // trace
        ...
        UIThreadRunnable.syncExec(new VoidResult() {
            @Override
            public void run() {
                ColorSettingsManager.setColorSettings(new ColorSetting[] { new ColorSetting(null, null, null, null) });
            }
        });
    }
}
