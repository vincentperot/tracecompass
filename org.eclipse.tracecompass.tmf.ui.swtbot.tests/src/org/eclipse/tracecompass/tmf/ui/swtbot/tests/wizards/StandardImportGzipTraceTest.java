...
public class StandardImportGzipTraceTest {
    ...
    public void testGzipImport() {
        ...
        IPath expectedElementPath = new Path(traceName);
        fBot.viewById(IPageLayout.ID_PROJECT_EXPLORER).setFocus();
        fBot.captureScreenshot("error.png");
        SWTBotUtils.openEditor(fBot, PROJECT_NAME, expectedElementPath);
        ...
        try {
            ...
            try (GZIPOutputStream gzos =
                ...
                try (FileInputStream in =
                        new FileInputStream(TmfTestTrace.A_TEST_10K2.getFullPath());) {
