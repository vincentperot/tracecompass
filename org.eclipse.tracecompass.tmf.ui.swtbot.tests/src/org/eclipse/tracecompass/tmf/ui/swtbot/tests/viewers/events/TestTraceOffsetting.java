...
public class TestTraceOffsetting {
    ...
    public void testOffsetting() {
        SWTBotUtils.createProject(TEST_FOR_OFFSETTING);
        SWTBotUtils.openTrace(TEST_FOR_OFFSETTING, fLocation.getAbsolutePath(), "org.eclipse.linuxtools.tmf.core.tests.xmlstub");
        SWTBotTreeItem treeItem = SWTBotUtils.selectTracesFolder(fBot, TEST_FOR_OFFSETTING);
        final SWTWorkbenchBot bot = new SWTWorkbenchBot();
        SWTBotTable eventsTableBot = bot.activeEditor().bot().table();
        ...
        shell.setFocus();
        final SWTBot shellBot = shell.bot();
