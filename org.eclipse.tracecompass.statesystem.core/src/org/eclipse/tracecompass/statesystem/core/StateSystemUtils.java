...
public final class StateSystemUtils {
    ...
    public static List<ITmfStateInterval> queryHistoryRange(ITmfStateSystem ss,
        ...
        if (t2 < t1) {
            throw new TimeRangeException("Start:" + t1 + ", End:" + t2); //$NON-NLS-1$ //$NON-NLS-2$
        }
    ...
    public static List<ITmfStateInterval> queryHistoryRange(ITmfStateSystem ss,
        ...
        if (t2 < t1 || resolution <= 0) {
            throw new TimeRangeException("Start:" + t1 + ", End:" + t2 + ", Resolution:" + resolution); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        }
