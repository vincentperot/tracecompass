...
public class InMemoryBackend implements IStateHistoryBackend {
    ...
    public void insertPastState(long stateStartTime, long stateEndTime,
        ...
        if (stateStartTime > stateEndTime || stateStartTime < startTime) {
            throw new TimeRangeException("Interval Start:" + stateStartTime + ", Interval End:" + stateEndTime + ", Backend Start:" + startTime); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        }
    ...
    public void doQuery(List<ITmfStateInterval> currentStateInfo, long t)
        ...
        if (!checkValidTime(t)) {
            throw new TimeRangeException("Time:" + t + ", Start:" + startTime + ", End:" + latestTime); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        }
    ...
    public ITmfStateInterval doSingularQuery(long t, int attributeQuark)
        ...
        throw new AttributeNotFoundException("Quark:" + attributeQuark); //$NON-NLS-1$
    }
