    ...
    public static CtfTmfEventField parseField(IDefinition fieldDef,
        ...
        if (fieldDef instanceof IntegerDefinition) {
            ...
            for (String curFieldName : strDef.getFieldNames()) {
                list.add(CtfTmfEventField.parseField(strDef.getDefinition(curFieldName), nullToEmptyString(curFieldName)));
            }
            ...
            String curFieldName = nullToEmptyString(varDef.getCurrentFieldName());
