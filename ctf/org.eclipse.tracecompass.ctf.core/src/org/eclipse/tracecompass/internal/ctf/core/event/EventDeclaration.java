...
public class EventDeclaration implements IEventDeclaration {
    ...
    private static long calculateTimestamp(ICompositeDefinition eventHeaderDef, long prevTimestamp, StructDefinition eventPayload) {
        long timestamp = 0;
        if (eventHeaderDef instanceof EventHeaderDefinition) {
            ...
            Definition def = eventHeaderDef.getDefinition(CTFStrings.TIMESTAMP);
