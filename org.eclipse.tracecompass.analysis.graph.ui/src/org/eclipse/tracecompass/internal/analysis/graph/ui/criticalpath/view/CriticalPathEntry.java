...
public class CriticalPathEntry extends TimeGraphEntry {
     ...
     */
    public CriticalPathEntry(String taskname, ITmfTrace trace, long startTime, long endTime, @Nullable IGraphWorker worker) {
     ...
     */
    public @Nullable IGraphWorker getWorker() {
        return fWorker;
    }
