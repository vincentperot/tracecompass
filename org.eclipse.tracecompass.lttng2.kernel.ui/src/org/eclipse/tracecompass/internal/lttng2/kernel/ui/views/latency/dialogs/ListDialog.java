 ...
 *******************************************************************************/
package org.eclipse.tracecompass.internal.lttng2.kernel.ui.views.latency.dialogs;
...
import org.eclipse.tracecompass.internal.lttng2.kernel.core.latency.analyzer.EventsPair;
        ...
        resetButton.addListener(SWT.Selection, new Listener() {
            ...
            public void handleEvent(Event event) {
                ...
                if (confirmDeletion) {
                    ...
                    Vector<String> defaultStarts = new Vector<>();
                    Vector<String> defaultEnds = new Vector<>();
