...
package org.eclipse.tracecompass.analysis.linux.core.kernelanalysis;
...
public class KernelAnalysis extends TmfStateSystemAnalysisModule {
    ...
    public static final String ID = "org.eclipse.tracecompass.analysis.linux.kernel"; //$NON-NLS-1$
