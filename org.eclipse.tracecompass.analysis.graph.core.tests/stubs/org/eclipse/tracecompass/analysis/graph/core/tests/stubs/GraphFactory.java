...
public class GraphFactory {
     ...
     */
    public static final Integer Actor0 = 0;

    /**
     * Second default actor of the graph
     */
    public static final Integer Actor1 = 1;
    ...
    public static final GraphBuilder GRAPH_BASIC =
            new GraphBuilder("basic") {
                ...
                public TmfGraph build() {
                    ...
                    graph.add(0, new TmfVertex(0));
                    graph.append(0, new TmfVertex(1), EdgeType.RUNNING);
                    return graph;
                }
    ...
    public static final GraphBuilder GRAPH_WAKEUP_SELF =
            new GraphBuilder("wakeup_self") {
                ...
                public TmfGraph build() {
                    ...
                    graph.append(0, vStart, EdgeType.RUNNING);
                    graph.append(0, new TmfVertex(2), EdgeType.RUNNING);
                    TmfVertex vEnd = new TmfVertex(3);
                    graph.append(0, vEnd, EdgeType.BLOCKED);
                    graph.append(0, new TmfVertex(4), EdgeType.RUNNING);
                ...
                public TmfGraph criticalPathBounded() {
                    ...
                    graph.append(0, new TmfVertex(1), EdgeType.RUNNING);
                    graph.append(0, new TmfVertex(2), EdgeType.RUNNING);
                    graph.append(0, new TmfVertex(3), EdgeType.TIMER);
                    graph.append(0, new TmfVertex(4), EdgeType.RUNNING);
                    return graph;
                }
    ...
    public static final GraphBuilder GRAPH_WAKEUP_MISSING =
            new GraphBuilder("wakeup_missing") {
                ...
                public TmfGraph build() {
                    ...
                    graph.add(0, new TmfVertex(0));
                    graph.append(0, new TmfVertex(2), EdgeType.RUNNING);
                    graph.append(0, new TmfVertex(4), EdgeType.BLOCKED);
                    graph.append(0, new TmfVertex(6), EdgeType.RUNNING);
                    return graph;
                }
    ...
    public static final GraphBuilder GRAPH_WAKEUP_UNKNOWN =
            new GraphBuilder("wakeup_unknown") {
                ...
                public TmfGraph build() {
                    ...
                    graph.add(0, new TmfVertex(0));
                    graph.append(0, new TmfVertex(2), EdgeType.RUNNING);
                    graph.append(0, vIn, EdgeType.BLOCKED);
                    graph.append(0, new TmfVertex(6), EdgeType.RUNNING);
                ...
                public TmfGraph criticalPathBounded() {
                    ...
                    graph.append(0, vStartBlock, EdgeType.RUNNING);
                    graph.add(0, vEndBlock);
                    graph.append(0, new TmfVertex(6), EdgeType.RUNNING);

                    TmfVertex vStartOther = new TmfVertex(2);
                    TmfVertex vEndOther = new TmfVertex(3);
                    graph.add(1, vStartOther);
                    graph.append(1, vEndOther, EdgeType.UNKNOWN);
                ...
                public TmfGraph criticalPathUnbounded() {
                    ...
                    TmfVertex vEndBlock = new TmfVertex(4);
                    graph.append(0, new TmfVertex(2), EdgeType.RUNNING);
                    graph.append(0, vStartBlock, EdgeType.UNKNOWN);
                    graph.add(0, vEndBlock);
                    graph.append(0, new TmfVertex(6), EdgeType.RUNNING);
    ...
    public static GraphBuilder GRAPH_WAKEUP_NEW =
            new GraphBuilder("wakeup_new") {
                ...
                public TmfGraph build() {
                    ...
                    graph.add(0, new TmfVertex(0));
                    graph.append(0, vSrcLink, EdgeType.RUNNING);
                    graph.append(0, new TmfVertex(4), EdgeType.RUNNING);
                    graph.append(0, vBlockEnd, EdgeType.BLOCKED);
                    graph.append(0, new TmfVertex(8), EdgeType.RUNNING);

                    graph.add(1, vDstLink);
                    graph.append(1, vWakeup, EdgeType.RUNNING);
                ...
                public TmfGraph criticalPathBounded() {
                    ...
                    graph.add(0, new TmfVertex(0));
                    graph.append(0, new TmfVertex(2), EdgeType.RUNNING);
                    graph.append(0, vBlockStart, EdgeType.RUNNING);
                    graph.add(0, vBlockEnd);
                    graph.append(0, new TmfVertex(8), EdgeType.RUNNING);
    ...
    public static GraphBuilder GRAPH_OPENED_DELAY =
            new GraphBuilder("opened") {
                ...
                public TmfGraph build() {
                    TmfGraph graph = new TmfGraph();
                    graph.add(0, new TmfVertex(0));
                    graph.append(0, new TmfVertex(3), EdgeType.RUNNING);
                    TmfVertex v1 = new TmfVertex(6);
                    graph.append(0, v1, EdgeType.BLOCKED);
                    graph.append(0, new TmfVertex(9), EdgeType.RUNNING);
                    graph.add(1, new TmfVertex(0));
                    TmfVertex v2 = new TmfVertex(2);
                    graph.append(1, v2, EdgeType.RUNNING);
                    graph.append(1, new TmfVertex(5), EdgeType.RUNNING);
                    graph.link(v2, v1);
                    return graph;
                }
                ...
                public TmfGraph criticalPathBounded() {
                    ...
                    graph.append(0, v1, EdgeType.RUNNING);
    ...
    public static GraphBuilder GRAPH_OPENED =
            new GraphBuilder("opened") {
                ...
                public TmfGraph build() {
                    ...
                    graph.append(1, v2, EdgeType.RUNNING);
                    graph.append(1, new TmfVertex(9), EdgeType.RUNNING);
                    graph.link(v2, v1);
                    return graph;
                }
                ...
                public TmfGraph criticalPathBounded() {
                    ...
                    TmfVertex v3 = new TmfVertex(6);
                    graph.add(1, v2);
                    graph.append(1, v3, EdgeType.RUNNING);
    ...
    public static GraphBuilder GRAPH_WAKEUP_MUTUAL =
            new GraphBuilder("wakeup_mutual") {
                ...
                public TmfGraph build() {
                    ...
                    graph.add(0, new TmfVertex(0));
                    graph.append(0, new TmfVertex(1), EdgeType.RUNNING);
                    graph.append(0, v0Wakeup, EdgeType.RUNNING);
                    graph.append(0, new TmfVertex(3), EdgeType.RUNNING);
                    graph.append(0, v0Unblock, EdgeType.BLOCKED);
                    graph.append(0, new TmfVertex(5), EdgeType.RUNNING);

                    /* Add actor 1's vertices and edges */
                    graph.add(1, new TmfVertex(0));
                    graph.append(1, new TmfVertex(1), EdgeType.RUNNING);
                    graph.append(1, v1Unblock, EdgeType.BLOCKED);
                    graph.append(1, new TmfVertex(3), EdgeType.RUNNING);
                    graph.append(1, v1Wakeup, EdgeType.RUNNING);
                    graph.append(1, new TmfVertex(5), EdgeType.RUNNING);
                ...
                public TmfGraph criticalPathBounded() {
                    ...
                    graph.append(0, new TmfVertex(1), EdgeType.RUNNING);
                    graph.append(0, new TmfVertex(2), EdgeType.RUNNING);
                    graph.append(0, v0StartBlock, EdgeType.RUNNING);
                    graph.add(0, v0EndBlock);
                    graph.append(0, new TmfVertex(5), EdgeType.RUNNING);

                    /* Add actor 1's vertices and edges */
                    graph.add(1, v1StartBlock);
                    graph.append(1, v1EndBlock, EdgeType.RUNNING);
                ...
                public TmfGraph criticalPathUnbounded() {
                    ...
                    graph.append(0, new TmfVertex(1), EdgeType.RUNNING);
                    graph.append(0, v0Wakeup, EdgeType.RUNNING);
                    graph.add(0, v0Unblock);
                    graph.append(0, new TmfVertex(5), EdgeType.RUNNING);

                    /* Add actor 1's vertices and edges */
                    graph.add(1, v1Unblock);
                    graph.append(1, new TmfVertex(3), EdgeType.RUNNING);
                    graph.append(1, v1Wakeup, EdgeType.RUNNING);
    ...
    public static GraphBuilder GRAPH_NESTED =
        ...
        private final Integer fActor2 = 2;
        private final Integer fActor3 = 3;
                @Override
                public TmfGraph build() {
                    /* Initialize some vertices */
                    TmfGraph graph = new TmfGraph();
