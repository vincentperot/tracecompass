...
public class GraphProviderStub extends AbstractTmfGraphProvider {
    ...
    private class StubEventHandler implements ITraceEventHandler {
        ...
        public void handleEvent(ITmfEvent event) {
            ...
            case "take":
            {
                Integer player = NonNullUtils.checkNotNull((Integer) event.getContent().getField("player").getValue());
            ...
            case "pass":
            {
                Integer playerFrom = NonNullUtils.checkNotNull((Integer) event.getContent().getField("from").getValue());
                Integer playerTo = NonNullUtils.checkNotNull((Integer) event.getContent().getField("to").getValue());
