...
/**
 * Module for the container CPU analysis. It tracks the status of the
 * CPU across multiple containers on the same host. The analysis is
 * based on LTTng kernel trace. Mostly process statedump and
 * sched_process_fork events.
 *
