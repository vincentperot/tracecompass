...
public class ContainerStateProvider extends AbstractTmfStateProvider {
     ...
     *            specific
     */
    public ContainerStateProvider(ITmfTrace trace, LttngEventLayout layout) {
    ...
    protected void eventHandle(@Nullable ITmfEvent event) {
        ...
        try {
            ...
            case SCHED_PROCESS_FORK: {
                ...
                final int parentTid, childTid, childVTid, childNSInum;
                ...
                ITmfEventField field = content.getField(fLayout.fieldChildVTid());
                if (field != null) {
                    childVTid = ((Long) field.getValue()).intValue();
                } else {
                    childVTid = -1;
                }
                ...
                TaskContainerEvent t = new TaskContainerEvent(ts, childTid, childVTid, parentTid, ContainerCpuState.CPU_STATUS_IDLE, cpu, childNSInum);
            ...
            case STATEDUMP_PROCESS: {
                ...
                Integer cpu = (Integer) cpuObj;
                TaskContainerEvent t = new TaskContainerEvent(ts, tID, vtID, ppID, status, cpu, nsInum);
                containerBuilder.insertTaskContainerEvent(ssb, t);
            }
                break;
