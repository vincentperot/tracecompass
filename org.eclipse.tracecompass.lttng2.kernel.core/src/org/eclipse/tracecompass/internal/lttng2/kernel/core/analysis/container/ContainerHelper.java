...
public class ContainerHelper {
    ...
    public static final int fCONTAINER_QUARK_NOT_FOUND = -1;
    ...
    private static int attachNewContainer(ITmfStateSystemBuilder ssb, int parentContainerINode, long timestamp, ContainerInfo containerInfo) {
        ...
        if (parentContainerQuark == fCONTAINER_QUARK_NOT_FOUND) {
            /*
     ...
     * This methods raise an exception if the container info is not found
     * because by design, we should always be able to find the container info
     * given a containerQuark as it is initialized with the container creation.
     *
     * @param ssb
     *            ITmfStateSystemBuilder
     ...
     *         it. Return null and throw and exception otherwise.
     */
    ...
    public static int getContainerFromTaskTid(ITmfStateSystemBuilder ssb, int taskTid) {
        ...
        int parentContainerQuark = fCONTAINER_QUARK_NOT_FOUND;
    ...
    /**
     * This scans every container for the given real TID, and if found, removes
     * it from the container along with it's VTID
     *
     * @param ssb
     *            ITmfStateSystemBuilder
     * @param timestamp
    ...
    public static boolean removeTaskFromContainer(ITmfStateSystemBuilder ssb, long timestamp, int realTIDToRemove) {
        ...
        if (containerQuark != ContainerHelper.fCONTAINER_QUARK_NOT_FOUND) {
            /*
