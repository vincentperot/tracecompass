...
public final class ContainerHelper {
    ...
    public static void addContainerAndTask(final ITmfStateSystemBuilder ssb, long timestamp,
            int parentNSInum, int childTid, int childVTid, ContainerInfo cInfo) {
    ...
    private static int getVTIDSection(ITmfStateSystemBuilder ssb, int containerQuark) {
        ...
        int vtidSectionQuark = -1;
        vtidSectionQuark = ssb.getQuarkRelativeAndAdd(containerQuark, ContainerAttributes.CONTAINER_TASKS);
        return vtidSectionQuark;
    }
