...
public interface PerfKernelConcepts {
    ...
    public class PerfSchedSwitchConcept implements ISchedSwitchConcept {

        private static final String SCHED_SWITCH = "sched:sched_switch"; //$NON-NLS-1$
        private static final String PREV_TID = "prev_pid"; //$NON-NLS-1$
        private static final String PREV_STATE = "prev_state"; //$NON-NLS-1$
        private static final String NEXT_COMM = "next_comm"; //$NON-NLS-1$
        private static final String NEXT_TID = "next_pid"; //$NON-NLS-1$
    ...
    public class PerfSchedWakeupConcept implements ISchedWakeupConcept {
