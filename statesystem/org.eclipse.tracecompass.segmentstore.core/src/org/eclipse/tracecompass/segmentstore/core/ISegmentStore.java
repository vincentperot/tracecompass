...
public interface ISegmentStore<T extends ISegment> extends Iterable<T> {
    ...
    /**
     * Retrieve all elements that inclusively cross another segment.
     *
     * This effectively means, all elements that respect *both* conditions:
     *
     * <ul>
     * <li>Their end is after the target's segment's start</li>
     * <li>Their start is before the target's segment's end</li>
     * </ul>
     *
     * @param segment
     *            The target segment
     ...
     */
    Iterable<T> getIntersectingElements(ISegment segment);
