 ...
 *     Bernd Hufmann - Rename file and update
 *******************************************************************************/
 ...
 * @noimplement
 */
public interface ITmfCompatibilityConstants {
    ...
    ImmutableSet<String> TRACE_INPUT_TYPE_CONSTANTS =
            ImmutableSet.of(ITmfCompatibilityConstants.TRACE_EDITOR_INPUT_TYPE,
    ...
    ImmutableSet<String> EXPERIMENT_INPUT_TYPE_CONSTANTS =
            ImmutableSet.of(ITmfCompatibilityConstants.EXPERIMENT_EDITOR_INPUT_TYPE,
