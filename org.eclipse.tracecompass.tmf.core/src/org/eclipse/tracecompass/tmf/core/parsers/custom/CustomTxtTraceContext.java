...
public class CustomTxtTraceContext extends TmfContext {
    ...
    public boolean equals(Object obj) {
        ...
        if (!NonNullUtils.equalsNonNull(firstLine, other.firstLine)) {
            return false;
        }
        if (!NonNullUtils.equalsNonNull(firstLineMatcher, other.firstLineMatcher)) {
            return false;
        }
        if (!NonNullUtils.equalsNonNull(inputLine, other.inputLine)) {
            return false;
        }
