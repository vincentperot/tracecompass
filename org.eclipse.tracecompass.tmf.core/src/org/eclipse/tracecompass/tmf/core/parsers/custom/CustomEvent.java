...
public class CustomEvent extends TmfEvent {
    ...
    public boolean equals(Object obj) {
        ...
        if (!NonNullUtils.equalsNonNull(fDefinition, other.fDefinition)) {
            return false;
        }
        ...
        if (!NonNullUtils.equalsNonNull(customEventContent, other.customEventContent)) {
            return false;
        }

        if (!NonNullUtils.equalsNonNull(customEventType, other.customEventType)) {
            return false;
        }
        return true;
    }
