...
public abstract class CustomTrace extends TmfTrace {
    ...
    public CustomTrace(CustomTraceDefinition definition) {
        fTraceTypeId = getTraceTypeId(getClass(), definition.categoryName, definition.definitionName);
    }
     ...
     */
    public static @NonNull String getTraceTypeId(Class<? extends ITmfTrace> traceClass, String category, String definitionName) {
