...
public class CustomTxtInputLine {
    ...
    private List<CustomTxtDataColumn> columns;
     ...
     *            Columns to use
     */
    public CustomTxtInputLine(Cardinality cardinality, String regex, List<CustomTxtDataColumn> columns) {
     ...
     *            The column to add
     */
    public void addColumn(CustomTxtDataColumn column) {
        if (columns == null) {
     ...
     * @return the columns
     */
    public List<CustomTxtDataColumn> getColumns() {
        return columns;
    }
