...
public class TmfAnalysisManager {
    ...
    /**
     * Constructor, not to be used TODO This class is not meant to be
     * instantiated, put me private in next major release
     *
     ...
     */
    public static Collection<IAnalysisModuleHelper> getAnalysisModule(String id) {
        Multimap<String, IAnalysisModuleHelper> map = getAnalysisModules();
        return NonNullUtils.checkNotNull(map.get(id));
    }
