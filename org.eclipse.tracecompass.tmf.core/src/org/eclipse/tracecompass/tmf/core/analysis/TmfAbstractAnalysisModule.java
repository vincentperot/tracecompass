...
public abstract class TmfAbstractAnalysisModule extends TmfComponent implements IAnalysisModule {
    ...
    private @Nullable String fName, fId;
    ...
    protected String getFullHelpText() {
        String text = NLS.bind(Messages.TmfAbstractAnalysisModule_AnalysisModule, getName());
        if (text == null) {
            text = ""; //$NON-NLS-1$
        }
        return text;
    ...
    protected String getShortHelpText(ITmfTrace trace) {
        String text = NLS.bind(Messages.TmfAbstractAnalysisModule_AnalysisForTrace, getName(), trace.getName());
        if (text == null) {
            text = ""; //$NON-NLS-1$
        }
        return text;
