 ...
 */
public abstract class AbstractTmfFilterTreeNode implements ITmfFilterTreeNode, Cloneable {
     ...
     *            the parent node
     */
    protected AbstractTmfFilterTreeNode(final ITmfFilterTreeNode parent) {
        if (parent != null) {
    ...
    /**
     * Get the field value for a given event
     *
     * @param event
     *            the event
     * @param field
    ...
    public ITmfFilterTreeNode clone() {
        try {
            AbstractTmfFilterTreeNode clone = (AbstractTmfFilterTreeNode) super.clone();
            clone.parent = null;
    ...
    public boolean equals(Object obj) {
        ...
        AbstractTmfFilterTreeNode other = (AbstractTmfFilterTreeNode) obj;
        if (children == null) {
