 ...
 * @since 1.0
 */
public class TmfVisibleRangeUpdatedSignal extends TmfSignal {
     ...
     *            The new time range
     */
    public TmfVisibleRangeUpdatedSignal(Object source, TmfTimeRange range) {
        super(source);
        fCurrentRange = range;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TmfVisibleRangeUpdatedSignal [source="); //$NON-NLS-1$
