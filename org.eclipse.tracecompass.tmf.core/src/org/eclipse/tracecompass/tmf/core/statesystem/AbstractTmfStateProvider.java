...
public abstract class AbstractTmfStateProvider implements ITmfStateProvider {
    ...
    private @Nullable ITmfStateSystemBuilder fStateSystemBuilder = null;
     ...
     */
    private void setStateSystemBuilder(@Nullable ITmfStateSystemBuilder stateSystemBuilder) {
    ...
    private class EventProcessor implements Runnable {
        ...
        private void closeStateSystem() {
            ...
            if (fStateSystemBuilder != null) {
                fStateSystemBuilder.closeHistory(endTime);
            }
        }
    }
