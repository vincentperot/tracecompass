...
public abstract class AbstractTmfStateProvider implements ITmfStateProvider {
    ...
    private static final int DEFAULT_EVENTS_SUBQUEUE_SIZE = 127;
    ...
    public AbstractTmfStateProvider(ITmfTrace trace, String id) {
        fTrace = trace;
        fEventsQueue = new BufferedBlockingQueue<>(DEFAULT_EVENTS_QUEUE_SIZE, DEFAULT_EVENTS_SUBQUEUE_SIZE);
