    ...
    interface BaseAspects {
        ...
        ITmfEventAspect TIMESTAMP = new AbstractTmfEventAspect() {
            ...
            public String getName() {
                String ret = Messages.AspectName_Timestamp;
        ...
        ITmfEventAspect EVENT_TYPE = new AbstractTmfEventAspect() {
            @Override
            public String getName() {
                String ret = Messages.AspectName_EventType;
                return (ret == null ? EMPTY_STRING : ret);
            }
        ...
        ITmfEventAspect CONTENTS = new AbstractTmfEventAspect() {
            @Override
            public String getName() {
                String ret = Messages.AspectName_Contents;
                return (ret == null ? EMPTY_STRING : ret);
            }
