...
public class TmfStateSystemAspect implements ITmfEventAspect {
    ...
    public String getName() {
        ...
        name = StateSystemUtils.attributePathToString(fSS.getFullAttributePathArray(fAttribute));
        return name;
    }
    ...
    public @NonNull String getHelpText() {
        return Messages.getMessage(NLS.bind(Messages.AspectHelpText_Statesystem,
                fSS.getSSID(), StateSystemUtils.attributePathToString(fSS.getFullAttributePathArray(fAttribute))));
    }
