...
public interface ITmfEventCriterion {
     ...
     */
    public static interface BaseCriteria {

        /** Criterion for the event timestamp */
        ITmfEventCriterion TIMESTAMP = new TmfTimestampCriterion();

        /** Criterion for the event type */
        ITmfEventCriterion EVENT_TYPE = new TmfEventTypeCriterion();

        /** Criterion for the aggregated event contents (fields) */
        ITmfEventCriterion CONTENTS = new TmfContentsCriterion();
    }
