...
public class StateValueCompareToTest {
    ...
    public void testIntValueComparisons() {
        ...
        try {
            ...
            fail("Integer value should not be comparable to string value");
    ...
    public void testLongValueComparisons() {
        ...
        try {
            ...
            fail("Long value should not be comparable to string value");
        } catch (StateValueTypeException e) {
    ...
    public void testDoubleValueComparisons() {
        ...
        try {
            ...
            fail("Double value should not be comparable to string value");
        } catch (StateValueTypeException e) {
    ...
    public void testStringValueComparisons() {
        ...
        try {
            ...
            fail("String value should not be comparable to int value");
        } catch (StateValueTypeException e) {

        }
        try {
            BASE_STRING_VALUE.compareTo(BASE_LONG_VALUE);
            fail("String value should not be comparable to long value");
        } catch (StateValueTypeException e) {

        }
        try {
            BASE_STRING_VALUE.compareTo(BASE_DOUBLE_VALUE);
            fail("String value should not be comparable to double value");
        } catch (StateValueTypeException e) {
