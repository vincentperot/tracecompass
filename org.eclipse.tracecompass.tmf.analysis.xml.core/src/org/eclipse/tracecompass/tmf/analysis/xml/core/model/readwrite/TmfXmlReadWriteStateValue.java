...
public class TmfXmlReadWriteStateValue extends TmfXmlStateValue {
    ...
    private static class AbstractTmfXmlStateValueHelper {

        public static @Nullable ITmfStateValue incrementByType(int quark, long timestamp, ITmfStateSystem ss, ITmfStateValue stateValue) throws AttributeNotFoundException {
    ...
    private class TmfXmlStateValueTmf extends TmfXmlStateValueTypeReadWrite {
        ...
        public void incrementValue(ITmfEvent event, int quark, long timestamp) throws StateValueTypeException, TimeRangeException, AttributeNotFoundException {
            ...
            ITmfStateValue value = AbstractTmfXmlStateValueHelper.incrementByType(quark, timestamp, ss, fValue);
            if (value != null) {
                processValue(quark, timestamp, value);
            } else {
    ...
    private class TmfXmlStateValueEventField extends TmfXmlStateValueTypeReadWrite {
        ...
        public void incrementValue(ITmfEvent event, int quark, long timestamp) throws StateValueTypeException, TimeRangeException, AttributeNotFoundException {
            ...
            ITmfStateValue value = AbstractTmfXmlStateValueHelper.incrementByType(quark, timestamp, ss, incrementValue);
            if (value != null) {
                processValue(quark, timestamp, value);
            } else {
