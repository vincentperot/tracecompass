...
public class TmfXmlReadWriteStateValue extends TmfXmlStateValue {
    ...
    private abstract class AbstractTmfXmlStateValueTypeReadWrite extends TmfXmlStateValueTypeReadWrite {
        ...
        protected @Nullable ITmfStateValue incrementByType(int quark, long timestamp, ITmfStateSystem ss, ITmfStateValue stateValue) throws AttributeNotFoundException {
    ...
    private class TmfXmlStateValueTmf extends AbstractTmfXmlStateValueTypeReadWrite {
    ...
    private class TmfXmlStateValueEventField extends AbstractTmfXmlStateValueTypeReadWrite {
    ...
    private class TmfXmlStateValueQuery extends AbstractTmfXmlStateValueTypeReadWrite {
