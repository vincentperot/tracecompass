...
public class TmfRangeSynchSignalTest {
    ...
    /**
     * Run the TmfTimeRange equals() method test.
     */
    @Ignore
    @Test
    public void testEquals() {
        TmfRangeSynchSignal fixture = new TmfRangeSynchSignal(TmfRangeSynchSignalTest.this, RANGE);
        TmfRangeSynchSignal other = new TmfRangeSynchSignal(TmfRangeSynchSignalTest.this, RANGE);
        TmfRangeSynchSignal otherNotEqual = new TmfRangeSynchSignal(TmfRangeSynchSignalTest.this, new TmfTimeRange(START_TIME, MIDDLE_TIME));
        assertEquals(fixture, other);
        assertNotEquals(fixture, otherNotEqual);
    }
    ...
    /**
     * Run the TmfTimeRange Hashcode() method test.
     */
    @Ignore
    @Test
